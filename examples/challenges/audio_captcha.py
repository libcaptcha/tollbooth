"""Audio CAPTCHA challenge. Requires: pip install tollbooth[audio]"""

from collections.abc import Iterable
from typing import Any
from wsgiref.simple_server import make_server

from tollbooth import AudioCaptcha, Rule, TollboothWSGI
...
if __name__ == "__main__":
    handler = AudioCaptcha(secret=SECRET.encode())
    wrapped = TollboothWSGI(app, SECRET, rules=RULES, challenge_handler=handler)
    print("AudioCaptcha challenge on http://localhost:8000")

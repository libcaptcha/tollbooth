"""Image selection CAPTCHA (6 images + preview). Requires: pip install tollbooth[image]"""

from collections.abc import Iterable
from typing import Any
from wsgiref.simple_server import make_server

from tollbooth import ImageCaptcha, Rule, TollboothWSGI
...
if __name__ == "__main__":
    handler = ImageCaptcha(secret=SECRET.encode())
    wrapped = TollboothWSGI(app, SECRET, rules=RULES, challenge_handler=handler)
    print("ImageCaptcha challenge on http://localhost:8000")
